    ...
    public class VRM10ExportDialog : EditorWindow
    {
        ...
        void OnExportClicked(GameObject root)
        {
            ...
            try
            {
                ...
                {
                    var glTFMaterial = materialExporter.ExportMaterial(m, textureExporter);
                    exporter.Storage.Gltf.materials.Add(glTFMaterial);
                }
                ...
                //
                {
                    ...
                    UniGLTF.Extensions.VRMC_vrm.GltfSerializer.SerializeTo(ref exporter.Storage.Gltf.extensions, vrm);
                }
                {
                    // springBone
                }
